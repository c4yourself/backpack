...
-- @param exchange_rate(optional) is a rate between this country and base currency. Default is 1

function Country:__init(name, country_code, currency_format, exchange_rate)
	self.name = name
	self.country_code = country_code
	self.currency_format = currency_format or "%.2f"
	self.exchange_rate = exchange_rate or nil
end
